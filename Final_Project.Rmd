...
## Push For $15
Minimum wage in the United States is a mess. The federally mandated minimum wage is 7.25/hour, the same level it has been since July 24th, 2009. 7.25 per hour doesn't sound like a lot, but due to inflation workers have been effectively getting a pay cut each year. You would have to make 8.60 in today's money to be on par with a worker making 7.25 more than a decade ago. The good news, at least for workers living in cities and states controlled by the Democratic party, is that minimum wage can be higher depending on the locality. Within the NYC-Newark-Bridgeport region alone there are more than five different minimum wages depending on where you are. The U.S unlike other countries does not index the federal minimum wage to inflation which can lead to the aforementioned situation where workers can lose out each year. Since 1968 the "real" minimum wage, meaning inflation adjusted, has varied wildly from state to state and even at the federal level. Below is a visualization representing five states with distinct present day minimum wages and it shows how the real minimum wage has changed.
...
For states like Washington and California, which started with higher minimum wages in 1968 the swings are very dramatic. The wage is almost cut in half from 1968 to 1990, with workers making 6.63 per hour in today's money. From 1990 to 2020 the wage then doubles with workers in those states making almost twice the amount of a minimum wage worker in Texas. For the states that had lower initial minimum wages the changes were not as dramatic. Texas and Minnesota have following almost the same trajectory until the mid 2010s, and Florida had been on the same path until the mid 2000s. It seems counter productive reopen the discussion on minimum wage every ten or so years, and to not have a livable minimum wage that is indexed to inflation. This article will explore the strangeness of the American minimum wage system, how it may or may not impact median income and unemployment, and how the U.S stacks up against the rest of the world. 

The push to raise the federal minimum wage has gained traction in recent years, and as Joe Biden has taken office the push has only grown more urgent. Most recently, Congressional Democrats have attempted to raise the minimum wage through a provision in the American Rescue Plan (COVID Relief Bill). Even among democrats the minimum wage hike did not have the votes to get through the senate and it has been delayed, potentially for years. Progressives in congress want there to be a 15.00 per hour minimum wage, but have not yet made plans for indexing it for inflation. Some republicans have sought a lower minimum wage, in the 10-11 dollar range, with an adjustment every two years for inflation. 

## "Effective" Minimum Wage
As previously mentioned, In the United States, States have some power over the minimum wage; However, the minimum wage cannot be lower than the federal minimum wage (7.25/hour). The Effective minimum wage in each state is either that states minimum wage, if it is above 7.25, or it is the federally mandated minimum wage. Below is what the effective minimum wages in each state looked like in 2019. Notice that a significant number of states are still at the federal minimum wage created in 2009. A 15 dollar per hour minimum wage would raise minimum wage in every state in the country. 
...
Now we know that minimum wage can vary widely by state and even more by city, but does it make a difference in how much the median worker is paid. After all, there are many countries where there is no minimum wage and the government relies on the free market to determine a fair wage. The United States presents an interesting case study as there are relatively few barriers to entry and exit, should a firm decide to move to a region where the minimum wage is lower. For example, a company could save almost five dollars per worker per hour if it were to move it's operations one state over from California to Nevada. You would think even between cities with differences in minimum wage there would be differences in median income and unemployment. Many opponents of a minimum wage hike say it will cost jobs and leads to a higher baseline of joblessness. I picked seven major cities in the U.S., each with a different minimum wage and compared their median incomes and unemployment rates.   
...
The United States is not far behind other developed nations when it comes to minimum wage; however, almost all other developed nations have seen their minimum wages rise in real terms while wages in the U.S. have fallen. The U.S. also has the most dramatic swings of any nation on the above visualization. A 15 dollar per hour would but the U.S. at one of the highest minimum wages in the world. 

## Conclusion
It's complicated. Like so many controversial issues the minimum wage has no clear solution. A 15.00 per hour wage could lift hundreds of thousands of Americans out of poverty, but maybe it wouldn't. It could reduce employment by over a million, but maybe it wouldn't. There are trade-offs, and it is never as clean cut as it seems. I hope this report helped make sense of what the current minimum wage in the United States, and what a 15 dollar per hour wage might look like. 
